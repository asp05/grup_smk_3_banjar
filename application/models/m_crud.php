...
class M_crud extends CI_Model
{
    ...
    public $table         = 'v_biosiswa';
    public $column_order  = array('nis', 'nama', 'jk', 'kelas', 'photo_siswa', null); //set column field database for datatable orderable
    public $column_search = array('nis', 'nama', 'jk'); //set column field database for datatable searchable just firstname , lastname , address are searchable
