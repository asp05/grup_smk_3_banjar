...
<body>
  <?php
    ...
    header("Content-Disposition: attachment; filename= Biodata Siswa.xls");
  ?>
  <center>
  ...
  <table border="1">
        <thead>
          <tr>
            ...
            <th width="400px"><center>Jenis Kelamin</center></th>
            <th width="200px"><center>Tempat Tanggal Lahir</center></th>
        ...
        ?>
          <tr>
            <td><center><?= $no++ ?></center></td>
              ...
              <td><center><?= $ez->tempat_ttl ?></center></td>
              <td><center><?= $ez->alamat?></center></td>
          </tr>
